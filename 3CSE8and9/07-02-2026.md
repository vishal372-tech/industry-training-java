...
* Always explain the brute force logic first.
* Then mention the optimized approach using minimum price tracking.
* The optimized solution is the **expected answer** in interviews.

---

This problem is a classic example of converting a quadratic solution into a linear-time optimized one.
